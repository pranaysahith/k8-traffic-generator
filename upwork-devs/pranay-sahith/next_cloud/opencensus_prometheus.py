...
class OpenCensusPrometheus:
    ...
    def __init__(self, test_id):
        ...
        download_measurement = self.create_measurement_view("download_file")
        upload_measurement = self.create_measurement_view("upload_file")
        self.measurements = {"download_file": download_measurement,
                             "upload_file": upload_measurement}
